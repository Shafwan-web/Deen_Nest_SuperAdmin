  ...
  return (
    <div>
      <div className="bg-[#FFFFFF] border border-[#f2f2f2] rounded-lg mt-6 p-4">
        ...
        <div className="flex flex-row justify-start gap-4 mt-6 md:mt-10">
          <div className="border-dashed border-2 border-[#F2F2F2] w-13 h-13 md:w-18 md:h-18 flex justify-center items-center">
            <img
              src={Image_Icon}
              alt="Image_Icon"
          ...
          <div className="flex flex-col gap-2 justify-center items-center">
            <div className="flex gap-4 justify-center items-center  ">
              <button
                className="bg-[#EEEEEE] text-[#181818] font-bold
              px-2 py-1 md:px-3 md:py-2 rounded-sm border-2 border-[#D9D9D9]"
              >
                Upload Logo
              </button>
              <button className="bg-primary px-2 py-1 md:px-3 md:py-2 text-white rounded-sm font-bold">
                Remove
              </button>
            </div>
            <div className="">
